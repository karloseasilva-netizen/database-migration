  ...
  head: () => ({
    meta: [
      { title: "Entrar ou cadastrar — Puro Fio Lingerie" },
      {
        name: "description",
        content:
          "Acesse sua conta Puro Fio ou crie um novo cadastro para acompanhar pedidos, favoritos e endereços.",
      },
      { property: "og:title", content: "Entrar — Puro Fio Lingerie" },
      {
        property: "og:description",
        content: "Acesse sua conta ou cadastre-se na Puro Fio Lingerie.",
      },
    ],
  }),
  component: AuthPage,
    ...
    >
      <div className="w-full max-w-md bg-background rounded-2xl border border-border shadow-sm p-8">
        <div className="text-center mb-6">
          <div className="mx-auto grid place-items-center h-14 w-14 rounded-full border border-primary/40 text-primary font-serif italic text-xl mb-3">
            PF
          </div>
        ...
        >
          <svg width="18" height="18" viewBox="0 0 48 48">
            ...
            <path
              fill="#FF3D00"
              d="M6.3 14.7l6.6 4.8C14.6 15.6 19 12.5 24 12.5c2.9 0 5.6 1.1 7.6 2.9l5.7-5.7C33.7 6.4 29.1 4.5 24 4.5 16.3 4.5 9.7 8.9 6.3 14.7z"
            />
            <path
              fill="#4CAF50"
              d="M24 43.5c5 0 9.6-1.9 13.1-5l-6.1-5c-2 1.4-4.4 2.3-7 2.3-5.3 0-9.7-3.4-11.3-8.1l-6.6 5.1C9.6 39 16.3 43.5 24 43.5z"
            />
            <path
              fill="#1976D2"
              d="M43.6 20.5H42V20H24v8h11.3c-.8 2.3-2.3 4.2-4.3 5.5l6.1 5c-.4.4 6.4-4.7 6.4-14 0-1.2-.1-2.3-.4-3.5z"
            />
          </svg>
