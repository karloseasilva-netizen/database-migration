  ...
  return (
    <footer className="mt-20 bg-secondary/40 border-t border-border/50">
      <div className="mx-auto max-w-7xl px-4 py-14 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
        <div>
          <img src={logoUrl} alt="Puro Fio Lingerie" className="h-16 w-auto object-contain" />
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-foreground/80">
            ...
            <li><a href="#" className="hover:text-primary transition">Área Administrativa</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-3 text-sm text-foreground/80">
            ...
            <li className="flex items-center gap-2">
              ...
              <a href="mailto:contato@purofio.com.br" className="hover:text-primary transition">
                contato@purofio.com.br
              </a>
            </li>
          </ul>
        </div>
      ...
      <div className="border-t border-border/50 py-5">
        <div className="mx-auto max-w-7xl px-4 text-center text-xs text-muted-foreground">
          © {new Date().getFullYear()} Puro Fio Lingerie. Todos os direitos reservados.
        </div>
      </div>
    </footer>
  );
